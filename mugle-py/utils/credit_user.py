...
print("Will add {} to users current balance of {} for a new balance of {}".format(amount, float(user_utxo.amount)/NANOMUGLE, float(user_utxo.amount)/NANOMUGLE+amount))
if debit_pool == "y":
    print("Will subtract {} from pool admin current balance of {} for a new balance of {}".format(amount, float(pooladmin_utxo.amount)/NANOMUGLE, float(pooladmin_utxo.amount)/NANOMUGLE-amount))
...
# Do it
user_utxo.amount += amount*NANOMUGLE
if debit_pool == "y":
    pooladmin_utxo.amount -= amount*NANOMUGLE

# Sanity Check
print("")
print("Users updated balance: {}".format(float(user_utxo.amount)/NANOMUGLE))
if debit_pool == "y":
    print("Pools updated balance: {}".format(float(pooladmin_utxo.amount)/NANOMUGLE))
