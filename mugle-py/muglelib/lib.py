...
#
# Common Routines for Mugle-Pool Services
#
...
def get_db():
    ...
    with rlock:
        if DATABASE is None:
            ...
            try:
                MUGLE_POOL_ADMIN_USER = os.environ['MUGLE_POOL_ADMIN_USER']
                MUGLE_POOL_ADMIN_PASSWORD = os.environ['MUGLE_POOL_ADMIN_PASSWORD']
                ...
                try:
                    ...
                    if user is None:
                        user = Users(
                                id = 1,
                                username = MUGLE_POOL_ADMIN_USER,
                                password = MUGLE_POOL_ADMIN_PASSWORD,
                            )
