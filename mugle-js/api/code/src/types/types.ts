export interface DatabaseMugleBlock {
    height: number,
    hash: string,
    version: number,
    previous: string,
...
export interface DatabaseMugleStat {
    difficulty: number,
    gps: number,
    edge_bits: number,
    height: number,
...
export interface DatabasePoolStat {
    ...
    edge_bits: number,
    gps: number,
    mugle_stats_id: null | number,
    pool_stats_id: null | number,
    worker_stats_id: null | number
}

export type MergeBlocksInput = DatabaseMugleStat | BlockGpsStat | DatabasePoolStat | WorkerGpsStat
...
export interface DatabaseShares {
  ...
  export type PoolSharesQueryResult = DatabaseMugleBlock & DatabasePoolStat

  export type UserSharesQueryResult = DatabaseWorkerShares & DatabaseMugleBlock & DatabaseShares