...
describe('networkRoutes return correct info', () => {
  describe('/GET block data', () => {
    it('/mugle/block should return latest block data', (done) => {
      chai.request(server)
        .get('/mugle/block')
        .end((err, res) => {
    ...
    it('/mugle/block/height should return accurate data', (done) => {
      chai.request(server)
        .get('/mugle/block/200')
        .end((err, res) => {
            res.should.have.status(200)
            // console.log('/mugle/block/200 response is: ', res.body)
            res.body.should.be.a('object')
            res.body.height.should.be.a('number')
    ...
    it('/mugle/blocks/height,range should return accurate range data', (done) => {
      chai.request(server)
        .get('/mugle/blocks/200,2')
        .end((err, res) => {
            res.should.have.status(200)
  ...
  describe('/GET network stats for range', () => {
    it('/mugle/stats/height,range should return valid network data', (done) => {
      chai.request(server)
        .get('/mugle/stats/2000,2/')
        .end((err, res) => {
  ...
  describe('/GET network stats for range', () => {
    it('/mugle/stats/height should return valid network data', (done) => {
      chai.request(server)
        .get('/mugle/stats/2000/')
        .end((err, res) => {
            // console.log('res is: ', res.body, ' and err is: ', err)          
            res.should.have.status(200)
            res.body.should.be.a('object')
