...
export const nanoMugleToMugle = (nanoMugle: number) => {
  return nanoMugle / 1000000000
}

export const mugleToNanoMugle = (nanoMugle: number) => {
  return nanoMugle * 1000000000
}

export const getMinerBlockRewardData = (height: number, networkData: Array<any>, muglePoolData: Array<any>, minerShareData: Object, selectedRigWorker?: string): Object | null => {
