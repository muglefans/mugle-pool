...
import { secondsToHms, nanoMugleToMugle } from '../../utils/utils.js'
...
export class MinerPaymentDataComponent extends Component {
  ...
  render () {
    ...
    const minerImmatureBalanceSyntax = (!isNaN(minerImmatureBalance) && minerImmatureBalance > 0) ? `${nanoMugleToMugle(minerImmatureBalance * 0.98).toFixed(9)} MUGLE` : 'n/a'
    return (
      <div>
        <h4>Payment Info</h4>
        <Table size='sm'>
          <tbody>
            <tr>
              ...
              <td>{nanoMugleToMugle(readableAmount)} MUGLE</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>Total Payouts</td>
              <td>{nanoMugleToMugle(totalPayoutsAmount)} MUGLE</td>
            </tr>
            <tr>
