...
import { nanoMugleToMugle } from '../../utils/utils.js'
      ...
      paymentRows = latestMinerPayments.map(payment => {
        ...
        return (
          <tr key={payment.id}>
            ...
            <td style={textDecoration}>{nanoMugleToMugle(payment.amount)} MUGLE</td>
            <td style={textDecoration}>{nanoMugleToMugle(payment.fee)} MUGLE</td>
