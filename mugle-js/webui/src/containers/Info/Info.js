    ...
    return (
      <Container className='dashboard'>
        <Alert className={'primary'} color='primary' style={{ fontSize: '1.1rem', textAlign: 'center', position: 'relative' }}>
          <p style={{ color: '#004085' }}>The following are the stratum server for connection to MuglePool:</p>
          <Table size='sm' hover style={{ marginBottom: '0px' }}>
            ...
            <tbody>
              <tr>
                ...
                <td>4</td>
                <td>No</td>
                <td>stratum.muglepool.com:3333</td>
              </tr>
            </tbody>
          </Table>
        </Alert>
          ...
          <Col xs={12} md={12} lg={6} xl={6}>
            <Card>
              <CardBody id='aboutPage'>
                <h4 className='bold-text'>About MuglePool</h4><br />
                ...
                <Table size='lg' responsive hover>
                  <tbody>
                    <tr>
                      ...
                      <td>stratum.muglepool.com:3334</td>
                    </tr>
                  </tbody>
                </Table>
              </CardBody>
