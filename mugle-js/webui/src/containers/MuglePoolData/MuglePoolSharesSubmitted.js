...
export class MuglePoolSharesSubmittedComponent extends Component {
  UNSAFE_componentWillMount () {
    const { fetchMuglePoolSharesSubmitted } = this.props
    fetchMuglePoolSharesSubmitted()
  }

  componentDidUpdate (prevProps) {
    const { latestBlockHeight, fetchMuglePoolSharesSubmitted } = this.props
