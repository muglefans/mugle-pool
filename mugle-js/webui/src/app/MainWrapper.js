...
const mapStateToProps = (state) => {
  const c29Blocks = state.muglePoolData.poolBlocksMined.c29 || []
  const c31Blocks = state.muglePoolData.poolBlocksMined.c31 || []
  const cumulativeRecentPoolBlocks = [...c29Blocks, ...c31Blocks]
  return {
    theme: state.theme,
    sidebar: state.sidebar,
    cumulativeRecentPoolBlocks,
    recentPoolBlocks: state.muglePoolData.poolBlocksMined,
